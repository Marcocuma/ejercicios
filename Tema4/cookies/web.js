...
if (document.cookie=="") {
    ...
    crearCookie("nombre",name,"Thu, 01 Nov 2019")
    var colorf= prompt("Introduce color de fondo");
    crearCookie("colorf",colorf,"Thu, 01 Nov 2019")
    var colorp= prompt("Introduce color del parrafo");
    crearCookie("colorfp",colorp,"Thu, 01 Nov 2019")
    var size= prompt("Introduce tamaño de texto");
    crearCookie("texts",size,"Thu, 01 Nov 2019")
